...
if __name__ == '__main__':
    ...
    if all([clip_model, clip_processor, caption_model, caption_tokenizer, key_frame_classifier]):
        train_transformer(clip_model, clip_processor, caption_model, caption_tokenizer, key_frame_classifier, LABELS_CSV, num_epochs=20)
